...
export const IPLHaarentfernung: React.FC = () => {
  return (
    <TreatmentTemplate
...
export const MesoBBGlow: React.FC = () => {
  return (
    <TreatmentTemplate
      title="Meso BB Glow"
      category="Teint & Glow"
...
export const Microneedling: React.FC = () => {
  return (
    <TreatmentTemplate
...
export const BrowLift: React.FC = () => {
  return (
    <TreatmentTemplate
...
export const Wimpernlifting: React.FC = () => {
  return (
    <TreatmentTemplate
...
export const KlassischeKosmetik: React.FC = () => {
  return (
    <TreatmentTemplate
...
export const FruchtsaeurePeeling: React.FC = () => {
  return (
    <TreatmentTemplate
...
export const VisiaHautanalyse: React.FC = () => {
  return (
    <TreatmentTemplate
...
export const MedicalKosmetikZO: React.FC = () => {
  return (
    <TreatmentTemplate
